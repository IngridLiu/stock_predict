...
data_df.to_csv(path_or_buf=data_root + file_name, sep=',', index_label='index')
print("Success to save data in file : "+data_root + file_name)
...
train_data_df.to_csv(path_or_buf=data_root + "train_data_{}_{}_{}.csv".format(dataset, vectors_dim, days_num), sep=',', index_label='index')
test_data_df = data_df[int(0.7*len(data_df)):]
train_data_df.to_csv(path_or_buf=data_root + "test_data_{}_{}_{}.csv".format(dataset, vectors_dim, days_num), sep=',', index_label='index')
